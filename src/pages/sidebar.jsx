...
function Sidebar() {
  ...
  const finance = [
    {
      label: "Dashboard",
      path: "dashboard",
      img: "../../../src/assets/elements-1.png",
      activeImg: "../../../src/assets/elements.png",
    },
    {
      label: "Products",
      path: "products",
      img: "../../../src/assets/list-unordered-2.png",
      activeImg: "../../../src/assets/list-unordered2.png",
    },
    {
      label: "Customers",
      path: "customers",
      img: "../../../src/assets/users.png",
      activeImg: "../../../src/assets/users-1.png",
    },
    {
      label: "Transactions",
      path: "transactions",
      img: "../../../src/assets/arrow-swap.png",
      activeImg: "../../../src/assets/arrow-swap2.png",
    },
    {
      label: "Analytics",
      path: "analytics",
      img: "../../../src/assets/procent.png",
      activeImg: "../../../src/assets/chartline2.png",
    },
    {
      label: "Team Management",
      path: "team-management",
      img: "../../../src/assets/user-square.png",
      activeImg: "../../../src/assets/user-square2.png",
    },
    {
      label: "Settings",
      path: "settings",
      img: "../../../src/assets/gear.png",
      activeImg: "../../../src/assets/gear (1).png",
    },
  ];
  ...
  const superAdmin = [
    ...
    },
    {
      ...
      path: "loans",
      img: "../../../src/assets/procent.png",
      activeImg: "../../../src/assets/percent.png",
    },
    {
      label: "Learn",
      path: "learn",
      img: "../../../src/assets/book-open.png",
      activeImg: "../../../src/assets/book-open2.png",
    },
  ...
  return (
    <div className="">
      <header className="relative bg-[#0F8ECD] px-4 py-[30px] flex justify-between items-center">
        ...
        >
          <div>
            <img src="../../../src/assets/Logo-blue.png" alt="logo" />
      ...
      <div className="flex gap-8 h-screen overflow-hidden ">
        <aside className="relative overflow-y-scroll hide-scrollbar px-4 py-2 w-[20%]">
          ...
          <div className="absolute flex gap-4 text-sm bottom-[20px]">
            <img src="../../../src/assets/log-out.png" alt="log-out" />
