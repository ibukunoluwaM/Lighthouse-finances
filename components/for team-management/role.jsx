...
function Roles() {
const roles = ["Super Admin", "Admin", "Support", "Compliance", "Technical"]
  //states to control time
  const [isOpen, setIsOpen] = useState(false);
  const [selectedTime, setSelectedTime] = useState(roles[0]);
  ...
  return (
        ...
        >
          ...
          {isOpen && (
            <div className="absolute w-[10rem] top-[45px] right-[20px]  bg-white p-2 text-sm  z-30">
              {roles.map((t, index) => (
